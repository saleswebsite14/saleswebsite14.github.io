(function(f){
    ...
    "use strict";var readSheet=require("./src/read"),appendRow=require("./src/append"),deleteRows=require("./src/delete"),editRows=require("./src/edit");
    function SteinStore(a){this.url=a.endsWith("/")?a:a+"/"}SteinStore.prototype.read=function(a){
        var b=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{},c=b.limit,d=b.offset,e=b.search,f=b.authentication;
        return readSheet(this.url,a,{limit:c,offset:d,search:e,authentication:f})},SteinStore.prototype.append=function(a,b){
            var c=2<arguments.length&&arguments[2]!==void 0?arguments[2]:{},d=c.authentication;
            return appendRow(this.url,a,b,{authentication:d})},SteinStore.prototype.edit=function(a,b){
                var c=b.search,d=b.set,e=b.limit,f=b.authentication;
                return editRows(this.url,a,{
                    search:c,set:d,limit:e,authentication:f
                })},SteinStore.prototype["delete"]=function(a,b){var c=b.search,d=b.limit,e=b.authentication;
                    return deleteRows(this.url,a,{search:c,limit:d,authentication:e})},module.exports=SteinStore;
